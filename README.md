# serverless_review_apps

This is a sample template for serverless_review_apps - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name serverless_review_apps \
...
aws cloudformation describe-stacks \
    --stack-name serverless_review_apps --query 'Stacks[].Outputs'
```
